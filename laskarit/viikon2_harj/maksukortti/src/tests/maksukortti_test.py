...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiiviisen_summan_lataaminen_ei_vie_saldoa_negatiiviseksi(self):
        self.kortti.lataa_rahaa(-20)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_kortilla_voi_syoda_edellisesti_tasarahalla(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
    ...
    def test_kortilla_voi_syoda_maukkaasti_tasrahalla(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
